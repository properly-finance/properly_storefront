...
import { createMuiTheme, createStyles, Theme, withStyles } from "@material-ui/core/styles";
...
interface IExtraPaletteOptions {
  textHighlighted?: {
    active: string;
    inactive: string;
  };
...
interface IPalette extends Palette, IExtraPaletteOptions {}
interface IPaletteOptions extends PaletteOptions, IExtraPaletteOptions {}
...
export const Baseline = withStyles(
